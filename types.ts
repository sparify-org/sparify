...
// Die Datenbank wurde geleert, damit neue Specials aufgesetzt werden können.
// Die Logik in den Komponenten (Shop, Detail, Settings) bleibt bestehen.
...
export const TRANSLATIONS: Record<Language, any> = {
  ...
  en: {
    ...
    shop: { title: 'Shop', subtitle: 'Buy items', specials: 'Specials', owned: 'Owned', sectionAvatars: 'Avatars', sectionThemes: 'Themes', balance: 'Coins' }
  },
  hr: {
  ...
  ru: {
    ...
    shop: { title: 'Магазиn', subtitle: 'Купить предметы', specials: 'Особое', owned: 'Куплено', sectionAvatars: 'Аватары', sectionThemes: 'Темы', balance: 'Монеты' }
  },
  hu: {
    ...
    age: { title: 'Majdnem kész!', subtitle: 'Hány éves oder?', hint: 'Ez nem befolyásolja a funkciókat, csak az alkalmazás dizájnját igazítja hozzád.', confirm: 'Mehet', years: 'év' },
