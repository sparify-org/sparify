...
export const LearnScreen: React.FC<LearnScreenProps> = ({ language, accentColor, user, onCompleteLevel, onLevelStart, onLevelEnd, appMode = 'kids' }) => {
  ...
  const LEVEL_CONTENTS: Record<string, LevelContent> = {
    ...
    'c_earn_game': [
      { type: 'slide', title: "Flohmarkt Profi", text: "Lerne zu handeln wie ein Profi!", icon: <ShoppingBag size={64} className="text-purple-500" /> },
      { type: 'question', question: "Jemand will nur 1€ zahlen, du willst 5€. Was tust du?", options: [{ text: "Verhandeln (z.B. 3€)", correct: true }, { text: "Weggehen", correct: false }], feedbackSuccess: "Genau, Treffen in der Mitte!", feedbackError: "Versuche immer erst zu verhandeln." }
    ],
    ...
    'c_spend_game': [
      { type: 'slide', title: "Supermarkt Rennen", text: "Finde die günstigsten Produkte!", icon: <ShoppingBasket size={64} className="text-red-500" /> },
      { type: 'question', question: "Schokolade an der Kasse (Quengelware)?", options: [{ text: "Ignorieren", correct: true }, { text: "Sofort kaufen", correct: false }], feedbackSuccess: "Stark geblieben!", feedbackError: "Das ist eine Falle der Supermärkte." }
    ],
    'c_spend_ex1': [
      { type: 'slide', title: 'Kiosk', text: 'Kleine Läden sind oft teurer als Supermärkte.', icon: <ShoppingBag size={64} className="text-orange-500" /> },
      { type: 'question', question: 'Eine Dose Cola kostet im Kiosk 2€, im Supermarkt 0,80€. Wo kaufst du?', options: [{ text: 'Supermarkt', correct: true }, { text: 'Kiosk', correct: false }], feedbackSuccess: 'Clever gespart!', feedbackError: 'Im Supermarkt ist es viel billiger.' }
    ],
    ...
    'c_save_bank': [{ type: 'slide', title: "Bankkonto", text: "Ein Ort, wo dein Geld sicher ist und manchmal sogar mehr wird.", icon: <Landmark size={64} className="text-slate-600" /> }],
    'c_save_ex1': [{ type: 'slide', title: "Zinsen", text: "Zinsen sind wie eine Belohnung fürs Sparen.", icon: <TrendingUp size={64} className="text-green-500" /> }],
    ...
    'c_safe_ex1': [{ type: 'slide', title: "Das Internet", text: "Kaufe nie etwas im Internet ohne deine Eltern.", icon: <Globe size={64} className="text-blue-500" /> }],
